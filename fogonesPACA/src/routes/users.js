...
router.get('/panelUsuario', loggeduserMiddleware, admindMiddleware, loginController.panelUser );
router.post('/panelUsuario/:id', loggeduserMiddleware, admindMiddleware, loginController.panelUserEdit )
router.get('/panelUsuario', loggeduserMiddleware, admindMiddleware, loginController.panelUser );
